 ...
 */
public class ShopGroupElement {
    String id;
    String groupName;
    Integer shown;
    Integer showInHierarchy;
    Integer systemGroup;
    
    public ShopGroupElement(String id, String groupName, Integer shown, Integer showInHierarchy, Integer systemGroup) {
        this.id = id;
        this.groupName = groupName;
        this.shown = shown;
        this.showInHierarchy = showInHierarchy;
    ...
    public Integer getShowInHierarchy() {
        return showInHierarchy;
    }

    public Integer getSystemGroup() {
        return systemGroup;
    }
